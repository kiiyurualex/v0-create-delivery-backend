...
const steps = [
  ...
  },
  {
    icon: Truck,
    title: "G4S Ships It",
    description: "Your package is picked up by G4S and securely transported to the destination.",
  },
  {
    icon: CheckCircle,
    title: "Delivery",
    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600">Simple steps to ship your packages across Kenya via G4S</p>
        </div>
